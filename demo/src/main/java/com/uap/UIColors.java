...
public class UIColors {
    public static final Color SIDEBAR_COLOR = new Color(44, 62, 80); // Dark Blue
    public static final Color HEADER_COLOR = new Color(52, 152, 219); // Light Blue
    ...
    public static final Color BTN_BLUE = new Color(41, 128, 185);
    public static final Color BTN_RED = new Color(231, 76, 60);
    public static final Color HOVER_COLOR = new Color(52, 73, 94); // Darker Blue
